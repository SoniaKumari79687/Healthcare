...
<head>
    <meta charset="utf-8">
    <title>MediConnect - Your Hub for Health</title>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="index.php" class="navbar-brand">
                    <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-clinic-medical me-2"></i>MediConnect</h1>
                </a>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (currentUrl === "") currentUrl = "index.php"; // Default to home

    let menuLinks = document.querySelectorAll(".navbar-nav .nav-link"); // Select only menu links
