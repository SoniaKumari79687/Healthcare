        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5" style="border-color: rgba(256, 256, 256, .3) !important;">Welcome To MediConnect</h5>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        ...
                        <form id="appoint_Form" method="POST">
                            <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" style="height: 55px;" name="department" required>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="date" id="date" data-target-input="nearest">
                                        <input type="date"
                                            ...
                                            placeholder="Date" data-target="#date" data-toggle="datetimepicker" style="height: 55px;" name="date" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="time" id="time" data-target-input="nearest">
                                        <input type="text"
                                            class="form-control bg-light border-0 datetimepicker-input"
                                            placeholder="Time" data-target="#time" data-toggle="datetimepicker" style="height: 55px;" name="time" required>
                                    </div>
                                </div>
                                <div class="col-12">
            ...
            <div class="owl-carousel team-carousel position-relative">
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Dr.Varun Bansal</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Cardiology Specialist</h6>
                                <p class="m-0">Expertise in heart failure surgeries including heart transplant & ECMO along with percutaneous procedures like TAVI in addition to routine and complex cardiac surgery.</p>
                            </div>
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Dr.S.K.GUPTA</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Nephrologist</h6>
                                <p class="m-0">The services he provides are Chronic Kidney Disease treatment, Percutaneous Nephrolithotomy, Percutaneous Nephrolithotripsy and Laparoscopic Nephrectomy.</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Dr.Smita Bhatia</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Vascular Surgeon</h6>
                                <p class="m-0">Treatment of Deep Vein Thrombosis (DVT) involving any vein & Pulmonary Embolism and its chronic complications. Using thrombolysis and or thrombosuction (penumbra).</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-facebook-f"></i></a>
